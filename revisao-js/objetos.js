/*
   Objetos são estrututas da linguagem JS que permitem armazenar
...
let pessoa = {
    ...
    dataNasc: '2000-09-18',
    ocupacao: 'estudante',
    // Quando nomes de propiedades contêm espaços ou
    // caracteres acentuados, eles devem vir ENTRE ASPAS
    'cidade de origem': 'Franca/SP',
    'série': '3º c',
    gostos: ['jogar', 'comer doces', 'dormir'] // Propiedade de vetor
}
...
// Una consequência da sintaxe dos colchetes é a possibilidade de
// ter nomes de propiedades dentro de variáveis

//Vetor com o nome das propiedades
...
// for.. in pode ser utilizdo juntamente com a sintaxe dos colchetes
