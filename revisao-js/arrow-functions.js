...
// 1 linha no corpo, com returb
function quadrado(x) {
    return x * x 
}

// ARROW FUNCTION: forma "abreviada" de escrever funçoes em JS

// Arrow function equivalente
// 1) A funçãi é atribuida a uma variável(ou ainda melhor, uma constante)
// 2) desaparece a palavra-chave "function"
// 3) desaparecem os parênteses em tornodo parâmetro
// 4) Entre o parâmetro e o corpo da função, temos o sinal "=>" (arrow, flecha)
// 5) Desaparece a palavra-chave "return"
...
// Arrow function correspondente
// Retornam as chaves delimitadas o corpo da função
const fatorial2 = n => {
    let res = 1
    for(let i = n; i > 1; i--) res *=i
    return res
